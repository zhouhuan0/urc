...
public class ZZService extends BaseServiceTest {
    ...
    public void getPlatformShopByEntityCode() throws Exception {
        String jsonStr = "{\"entityCode\":\"E_PlatformShopSite\",\"ticket\":\"4ec273ef50fa98f390dca6fc7fa7afef\",\"operator\":\"panyun1\",\"personName\":\"潘韵1\",\"funcVersion\":\"1ad42b3f589e1fb8da27ae531b3524d5\",\"moduleUrl\":\"/user/usermanagementlist/datapauthorization/\",\"requestId\":\"080116055154688c039a6d75faf20d5d\",\"deviceName\":\"Chrome浏览器\"}";
        ResultVO resultVO = urcService.getPlatformCode(jsonStr);
        System.out.println(StringUtility.toJSONString(resultVO));

        jsonStr = "{\"entityCode\":\"E_PlsShopAccount\",\"ticket\":\"4ec273ef50fa98f390dca6fc7fa7afef\",\"operator\":\"panyun1\",\"personName\":\"潘韵1\",\"funcVersion\":\"1ad42b3f589e1fb8da27ae531b3524d5\",\"moduleUrl\":\"/user/usermanagementlist/datapauthorization/\",\"requestId\":\"0801161223781042872bcf2d52ca7027\",\"deviceName\":\"Chrome浏览器\"}";
        resultVO = urcService.getPlatformCode(jsonStr);
        System.out.println(StringUtility.toJSONString(resultVO));
    }
